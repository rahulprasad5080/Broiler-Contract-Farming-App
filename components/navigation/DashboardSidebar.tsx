...
const ownerRoutes: DashboardSidebarRoute[] = [
  ...
  {
    title: "Treatments",
    subtitle: "Treatment list and create",
    icon: "medical-outline",
    route: "/(owner)/manage/treatments" as Href,
    section: "Entries",
  ...
  },
  {
    ...
    route: "/(owner)/manage/comments" as Href,
    section: "Entries",
  ...
  },
  {
    ...
    route: "/(owner)/manage/farms/add" as Href,
    section: "Management",
    requiredPermission: "manage:farms",
  },
  {
  ...
  },
  {
    title: "Create Batch",
    icon: "add-circle-outline",
    route: "/(owner)/manage/batches/create" as Href,
    section: "Management",
    requiredPermission: "manage:batches",
  },
  {
  ...
  },
  {
    ...
    route: "/(owner)/manage/partners/createupdate?partnerKind=vendor" as Href,
    section: "Management",
    requiredPermission: "manage:partners",
  },
  {
    title: "Add Trader",
    icon: "person-add-outline",
    route: "/(owner)/manage/partners/createupdate?partnerKind=trader" as Href,
    section: "Management",
    requiredPermission: "manage:partners",
  },
  {
  ...
  },
  {
    title: "Create User",
    icon: "add-circle-outline",
    route: "/(owner)/manage/users/create" as Href,
    section: "Management",
    requiredPermission: "manage:users",
  },
  {
  ...
  },
  {
    ...
    icon: "add-circle-outline",
    route: "/(owner)/manage/dropdowns/create" as Href,
    section: "Management",
    requiredPermission: "manage:users",
  },
  {
  ...
  },
  {
    ...
    icon: "add-circle-outline",
    route: "/(owner)/manage/catalog/createupdate" as Href,
    section: "Management",
    requiredPermission: "manage:inventory",
  },
  {
    ...
    icon: "cube-outline",
    route: "/(owner)/manage/inventory" as Href,
    section: "Finance",
    requiredPermission: "manage:inventory",
  },
  {
  ...
  },
  {
    ...
    icon: "add-circle-outline",
    route: "/(owner)/manage/purchase/createupdate" as Href,
    section: "Finance",
    requiredPermission: "create:purchase",
  },
  {
  ...
  },
  {
    ...
    icon: "add-circle-outline",
    route: "/(owner)/manage/entries/create" as Href,
    section: "Finance",
    requiredPermission: "view:financial-dashboard",
  },
  {
    ...
    icon: "document-text-outline",
    route: "/(owner)/manage/finance-entry" as Href,
    section: "Finance",
    requiredPermission: "view:financial-dashboard",
  },
  {
  ...
  },
  {
    ...
    icon: "add-circle-outline",
    route: "/(owner)/manage/payments/create" as Href,
    section: "Finance",
    requiredPermission: "manage:settlements",
  },
  {
  ...
  },
  {
    ...
    route: "/(owner)/manage/settings" as Href,
    section: "More",
    requiredPermission: "manage:users",
  },
  {
