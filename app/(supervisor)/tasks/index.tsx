...
export default function SupervisorTasksIndexScreen() {
  ...
  const menuItems = [
    ...
    { title: 'Treatments', desc: 'View and log vaccines or medicines', icon: 'medical-outline', route: '/(supervisor)/tasks/treatments' },
    { title: 'Comments & Notes', desc: 'View batch feedback and notes', icon: 'chatbubbles-outline', route: '/(supervisor)/tasks/comments' },
