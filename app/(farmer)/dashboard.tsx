...
const styles = StyleSheet.create({
  ...
  greetingText: { fontSize: 16, fontWeight: '800', color: '#111827' },
  ...
  batchTitle: { fontSize: 15, fontWeight: '800', color: '#111827' },
  ageBadge: {
    width: 48,
    height: 48,
    borderRadius: 14,
  ...
  ageValue: { fontSize: 16, fontWeight: '900', color: THEME_GREEN },
  ...
  actionBtnTitle: { fontSize: 14, fontWeight: '800', color: '#FFF' },
  ...
  envVal: { fontSize: 16, fontWeight: '900', color: '#111827' },
